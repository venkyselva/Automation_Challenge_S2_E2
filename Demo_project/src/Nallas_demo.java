	...
	public static void main(String[] args) 
	{
     ...
     try
     {
 		...
 		//---Element initialization----
          ...
          userEnt = new JTextField("", 8);
          userEnt1 = new JTextField("", 8);
 			  ...
 			  public void actionPerformed(ActionEvent e){
 				...
 				finalstring1 = userEnt1.getText();
 				 ...
 				 if(!finalstring.equals("")&&!finalstring1.equals(""))
 				 {
 			    	 ...
 			    	 Matcher n = p.matcher(finalstring1);
 			    	 Boolean status =  m.matches();
 			    	 Boolean status1 =  n.matches();
 			    	System.out.println("input regex status"+status);
 			    	 if(status==false ||status1==false)
 			    	 {
 			    		...
 			    		Set_list1.setText("<html><br>"+"Matrix Generation:-- "+ Verification+" --**</html>");
 			    		finalstring="";
 			    	 }
 			    	 else
 			    	 {
 			    		matrixgeneration();
 					Set_list1.setText("<html><br>"+"Matrix Generation:-- "+ "Sprial Matrix Created Successfully"+" --**</html>");
 					
 					JOptionPane.showMessageDialog(null, finalvalue, "InfoBox: " + "Sprial Matrix", JOptionPane.INFORMATION_MESSAGE);
 					finalstring="";
 			    	 }
 				 }
 				 else
 				 {
 					...
 					Set_list1.setText("<html><br>"+"Matrix Generation: -- "+ Set2+" --**</html>");
 					finalstring="";
 				 }
          ...
          reset.addActionListener(new ActionListener(){  
 			  public void actionPerformed(ActionEvent e){
 				 ...
 				 Set1 = "Reset Completed";
					Set_list1.setText("<html><br>"+"Matrix Generation :-- "+ Set1+" --**</html>");
					finalstring ="";
					finalstring1 ="";
					finalvalue="";
 			  }});
